<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="userprofile.aspx.cs" Inherits="UserManagementSystem3.userprofile" %>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-8 mx-auto">
                        <center>
                           <div class="form-group">
                              <asp:Button class="btn btn-primary btn-block btn-lg" ID="btnUserupdate" runat="server" Text="Update" OnClick="btnUserupdate_Click" />
                           </div>
                        </center>
                     </div>
                  </div>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <h4>Your Details</h4>
                           <asp:Label class="badge badge-pill badge-info" ID="Label2" runat="server" Text="Your Details Info"></asp:Label>
                        </center>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DB_UserManagementSystemConnectionString %>" SelectCommand="SELECT * FROM [tbl_UserMaster]"></asp:SqlDataSource>
                     <div class="col">
                        <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="user_id" DataSourceID="SqlDataSource1">
                            <Columns>
                                ...
                                <asp:BoundField DataField="udob" HeaderText="Date Of Birth" SortExpression="udob" />
                                <asp:BoundField DataField="contact" HeaderText="Contact No." SortExpression="contact" />
                                <asp:BoundField DataField="uemail" HeaderText="Email ID" SortExpression="uemail" />
                                ...
                                <asp:BoundField DataField="ufull_address" HeaderText="Address" SortExpression="ufull_address" />
                            </Columns>
                         </asp:GridView>
                     </div>
                  </div>
